                        ...
                        <Collapse isOpen={this.state.isNavOpen} navbar>
                            <Nav navbar>
                                ...
                                <NavItem>
                                    <NavLink className="nav-link" to="/species">
                                        <i className="fa fa-list fa-lg" /> Species
                                    </NavLink>
                                </NavItem>
                                <NavItem>
                                    <NavLink className="nav-link" to="/aboutrobos">
                                        <i className="fa fa-info fa-lg" /> About Robos
                                    </NavLink>
                                </NavItem>
                                <NavItem>
                            ...
                            <span className="navbar-text ml-auto">
                                <Button outline onClick={this.toggleModal}>
                                    <i className="fa fa-sign-in fa-lg" /> Subscription Login
                                </Button>
                            </span>
                        </Collapse>
                    </div>
